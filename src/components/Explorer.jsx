...
const Explorer = () => {
  ...
  return (
    ...
    <Link className='aboutMe' style={{display : 'flex' ,gap : '5px', textAlign : 'center',alignItems : 'center'}} to = "/myPic"><div style={{ width : '20px' , height : '20px' }}><img style={{width : '100%', height : '100%'}} src="public\icons8-image-file-240.png" alt="" /></div> myPhoto.jpg</Link>
